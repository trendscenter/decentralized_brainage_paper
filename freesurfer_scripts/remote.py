...
OUTPUT_KEY_LIST = ['w_local', 'intercept_local', 'n_samples_local', 'rmse_train_local', 'rmse_test_local',
                   'mae_train_local', 'mae_test_local']
...
def remote_0(args):
    ...
    cache_dict["n_samples_locals"] = aggegated_dict["n_samples_local"].tolist()
...
def remote_1(args):
    ...
    output_dict = {
        ...
        # owner
        "n_samples_train_owner": [dict_owner.get("n_samples_train_owner"), "number"],
        "n_samples_test_owner": [dict_owner.get("n_samples_test_owner"), "number"],
